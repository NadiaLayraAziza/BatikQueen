(function (window, undefined){
	...
	DialogBox.prototype = {
		...
		loadDialog: function(){
			...
			htmlDialog += '<p align="center" class="pjDbPopupFormTitle">Daftar Gratis Untuk Menjelajahi Semua Fitur BatikQueen</p>';
			htmlDialog += '</header>';
			htmlDialog += '<div class="pjDbPopupFormBody">';
			htmlDialog += '<div class="pjDbPopupFormRow">';
			htmlDialog += '<label for="" class="pjDbPopupFormLabel">Username: </label>';
			...
			htmlDialog += '<li><a align="center" href="toko.html" <button type="button" class="pjDbPopupBtn pjDbPopupBtnPrimary pjDbBtnSubmit">Daftar</button></a></li>';
			htmlDialog += '</div>';
			htmlDialog += '</footer>';
			htmlDialog += '</form>';
			htmlDialog += '</div>';
