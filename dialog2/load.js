(function (window, undefined){
	...
	DialogBox.prototype = {
		...
		loadDialog: function(){
			...
			htmlDialog += '<p align="center" class="pjDbPopupFormTitle">Masuk ke Akun Anda</p>';
			htmlDialog += '</header>';
			...
			htmlDialog += '<input type="text" name="Email" class="pjDbPopupFormField required" placeholder="Email" />';
			htmlDialog += '<label class="pjDbFieldError"></label>';
			htmlDialog += '</div>';
			htmlDialog += '</div>';
			htmlDialog += '<div class="pjDbPopupFormRow">';
			htmlDialog += '<label for="" class="pjDbPopupFormLabel">Password: </label>';
			htmlDialog += '<div class="pjDbPopupFormControls">';
			htmlDialog += '<input type="password" name="password" id="password" tabindex="2" autocomplete="current-password" name="Password" class="pjDbPopupFormField required email"/>';
			htmlDialog += '<label class="pjDbFieldError"></label>';
			htmlDialog += '</div>';
			htmlDialog += '</div>';
			htmlDialog += '</div>';
			htmlDialog += '<footer align="center" class="pjDbPopupFormFoot">';
			htmlDialog += '<div class="pjDbPopupFormActions">';
			htmlDialog += '<li><a href="beranda.html" <button type="button" align="center" class="pjDbPopupBtn pjDbPopupBtnPrimary pjDbBtnSubmit">Masuk</button></a></li>';
			htmlDialog += '</div>';
			htmlDialog += '</footer>';
			htmlDialog += '</form>';
			htmlDialog += '</div>';
